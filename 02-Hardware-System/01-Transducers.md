...
| **驻极体 (ECM)** | 永久极化电容 | -42 dBV | 50-16kHz | 2-10V | 传统手机/耳机 |
| **MEMS** | 微机械振膜+ASIC | -38 dBV | 50-20kHz | 1.8-3.3V | 智能手机/车载 |
...
| 封装 | 声孔位置 | 优势 | 应用 |
|:---|:---|:---|:---|
| **Top-Port** | 顶部开孔 | SMD 回流焊友好 | 智能手机底部MIC |
| **Bottom-Port** | 底部开孔 (PCB 打孔) | 密封性好，防尘 | 手机顶部/耳机 |

**关键指标**：

| 指标 | 入门级 | 主流级 | 高端级 | 说明 |
|:---|:---|:---|:---|:---|
| **SNR** | 61-63 dB | 64-67 dB | 68-74 dB | 信噪比 (越高越好) |
| **AOP** | 120 dBSPL | 125 dBSPL | 130+ dBSPL | 声学过载点 (越高失真越少) |
