# ASoC Driver Model Content Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create a high-quality technical document `02-ASoC-Driver-Model.md` in the `05-Linux-Audio-Subsystem` directory.
...
### Task 1: Write 05-Linux-Audio-Subsystem/02-ASoC-Driver-Model.md

**Files:**
- Create: `05-Linux-Audio-Subsystem/02-ASoC-Driver-Model.md`

- [ ] **Step 1: Write the content of 02-ASoC-Driver-Model.md**

Write the following content to `05-Linux-Audio-Subsystem/02-ASoC-Driver-Model.md`:
...
*   **自动开关**：DAPM 引擎会根据当前是否在录音或播放，自动计算出一条完整的音频通路，并只开启该通路上的节点，其余节点自动断电以省电。
...
Run:
```bash
git add 05-Linux-Audio-Subsystem/02-ASoC-Driver-Model.md
git commit -m "feat: add ASoC driver model chapter"
```
